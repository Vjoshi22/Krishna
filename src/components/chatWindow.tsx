    ...
    public render(): React.ReactElement<IChatWindowProps> {
        return (
            ...
            <div className={styles.chatWindow}>
                ...
                {/* <div>
                <iframe src='https://webchat.botframework.com/embed/KnowledgeMiningBot?s=17OulKhU1MI.RUgQ599O4qlVTmW_EJnBisSH5kRpKaALmlnb_uQMH5s' height="200" width="200"></iframe>
                </div> */}
            </div>
        );
    }
